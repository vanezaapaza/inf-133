...
class EstudiantesService: #creamos una clase para que tenga solo una responsabilididad, este se encarga de los estudiantes
    @staticmethod
    def find_student(id):
        return next(
...
class HTTPResponseHandler: #creamos otra clase para que tenga la responsabilidad de respuestas unicamente
    @staticmethod
